...
And thus, we learned all the theories of physics across centuries, by reading just about 5 pages. It is time for us to see what is really missing. We are trying to explain the objective world through the scientific laws. This world runs on an arena of space and time, well actually, spacetime as we have learned, and matter and energy inside it which evolves with time. We have physical laws that explain how this world evolves. Is that it? Do we have laws which explain everything about how this world evolves accurately? Not really. There are still plenty of unsolved problems.

### The Big, the Small and the Beautiful

We have entities like space, time, and fundamental particles that we use to explain the universe. When we try to stretch their limits and push their boundaries, we run into many issues.

#### The Big

How big is the Universe? Is there a boundary to space or time or spacetime? If there is a boundary, what lies outside of it? Or is it infinite? There is a theory that the universe is finite but unbounded. In this type of universe, if we keep travelling one direction, we will eventually come back to where we started. It is similar to a two dimensional being that walks around the earth in one direction will never reach a boundary and will end up where they started again.


We don’t know the answer to these questions. If you read many articles about the cosmos, you will see that scientists often use the term Observable Universe to make it clear that they are only talking about the universe we can observe irrespective of where its real boundary may be. For all we know, we may be only observing 1% of the entire universe or the universe may just be infinite or even a hypersphere that isn’t bounded but is finite.


The question of how big it is doesn’t just pertain to the spatial view of the universe. It is also a question about the time axis of the universe. Does time go infinitely backward and forwards? For a long time, the answer to this question was thought to be yes, until we started using the theory of relativity and observations in space as we started understanding the universe better.
...
In the last two theories, time continues to exist without a boundary whereas in the first two theories, time does have an end at some point.

#### The Small

The next question we ask ourselves is how small can we divide the things we see in this world?
