...
What do I mean by this? Right now, I am typing this out in my room. I can observe the entirety of the room. But I am not observing anything outside my room. I am not observing anything happening outside my home, my country, this planet, the solar system and so on. I just assume that Jupiter is there somewhere going around the sun dancing with its moons.



Isn’t this just too obvious? Why is it a brute statement? Remember, we started with a clean slate. Nothing should be taken for granted. Let’s say that the world is just a computer simulation and thanks to chip shortage in the parent world, the computer only simulates what you are looking at, following certain rules but it doesn’t simulate anything when you aren’t looking. Is there an objective world in this case? Maybe, maybe not. The existence of an objective world is something we take for granted and it counts as a Brute Statement in our system.
...
Solipsism is the idea that only your own mind is sure to exist. You don’t have access to someone else’s mind. We can see brains using a scanner. But a brain doesn’t have to result in a mind.
