...
Let us begin with the kind of problems Philosophy tries to solve. The first thing that comes to the mind of most people when they think about philosophy is “Why?” Let us look at some examples to see what the why question means in this context.
...
As you can see, the different why questions have different answers. In the case of the parked car, the answer was about what happened in the past, that explains the state of things in the present. In the case of roses, the answer explained the colour phenomenon in terms of what happens at a molecular level. In the case of the lemons, we answered it by saying what we plan to do in the future. In the case of drunken driving questions, we answered in terms of what we do not want to happen in the future. In the case of the triangle question, the answer was a mathematical proof using mathematical concepts.
...
Now, the why question doesn’t stop there. I can ask him why he wants to drink lemon juice everyday. He then tells me about a health article that he read about the benefits of drinking lemon juice every day. I can ask again, why the health article says it is healthy. He might explain the presence of Vitamin C in lemons that gives us health benefits. I can test this person’s patience by asking why again. At this point, he will ask me to do one. But anyway, you see what I am getting at?


Pretty much every event that happens and every fact known can be formulated as part of the why question if we want a reason or an explanation. To formalise it, asking the why question about an event or a fact implies that the person asking the question is missing some information or knowledge that would explain this event or fact.
